...
for entry in faculty:
    ...
    # Bio Section
    baseURL = 'http://www.terry.uga.edu'
    bio = ''
    try:
        bio = baseURL + entry.find('a')['href']
    except TypeError:
        bio = ''
    ...
    facultyData.append(dict([('name', name), ('title', title), ('picture', picture), ('bio', bio), ('office', office), ('email', email)]))
...
for program in programs:
    ...
    for course in courses:
        ...
        if level == 'Undergraduate Level':
            undergradData.append(
                dict([('level', level), ('link', baselink + courseLink), ('abbrev', abbrev), ('name', name), ('information', information)]))
        elif level == 'Graduate Level':
            gradData.append(dict([('level', level), ('link', baselink + courseLink),('abbrev', abbrev), ('name', name), ('information', information)]))
